...
type Replica struct {
	*genericsmr.Replica // extends a generic Paxos replica
	...
	Shutdown bool
	data     map[int]pineapplereplicaproto.Payload
...
func NewReplica(id int, peerAddrList []string, exec bool, dreply bool) *Replica {
	...
	r := &Replica{
		...
		false,
		false,
		map[int]pineapplereplicaproto.Payload{},
...
func (r *Replica) bcastGet(instance int32, write bool, key int) {
	...
	args := &pineapplereplicaproto.Get{ReplicaID: r.Id, Instance: instance, Write: wr, Key: key}
...
func (r *Replica) handleGet(get *pineapplereplicaproto.Get) {
	...
	if r.instanceSpace[r.crtInstance] == nil || !doesExist { // TODO: Is this block needed?
		getReply = &pineapplereplicaproto.GetReply{Instance: get.Instance, OK: ok, Write: get.Write,
			Key: get.Key, Payload: pineapplereplicaproto.Payload{}, // TODO: test removing payload
		}
	...
	if getReply.OK == TRUE {
		...
		if inst.lb.prepareOKs+1 > r.N>>1 {
			...
			if getReply.Write == 1 {
				write = true
				r.mu.Lock()
				newTag := pineapplereplicaproto.Tag{Timestamp: r.data[key].Tag.Timestamp + 1, ID: int(r.Id)}
				r.data[key] = pineapplereplicaproto.Payload{Tag: newTag, Value: r.data[key].Value}
				r.mu.Unlock()
			}
			r.sync()
...
func (r *Replica) bcastSet(instance int32, write bool, key int, payload pineapplereplicaproto.Payload) {
	defer func() {
		if err := recover(); err != nil {
	...
	args := &pineapplereplicaproto.Set{ReplicaID: r.Id, Instance: instance, Write: wr,
...
func (r *Replica) handleSet(set *pineapplereplicaproto.Set) {
	...
	setReply = &pineapplereplicaproto.SetReply{Instance: set.Instance}
...
func (r *Replica) handlePropose(propose *genericsmr.Propose) {
	...
	*/
	...
	r.data[key] = pineapplereplicaproto.Payload{
